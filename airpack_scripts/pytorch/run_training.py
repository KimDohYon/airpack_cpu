...
def main(data_folder: Union[str, os.PathLike], n_epoch: int = 10) -> float:
    ...
    input_len = 38400  # signal Window length in complex samples
    output_len = 2  # Number of signal classes
    learning_rate = 1e-3    # Learning rate
    batch_size = 16  # Number of signals to average for each training calculation
